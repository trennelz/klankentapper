...
export function TypoBreaker() {
  return (
    <section className="relative overflow-hidden bg-cornsilk px-6 py-28 md:px-10 md:py-40">
      {/* Concentric lines — right side, masked so they dissolve at the edges */}
      <div
        className="pointer-events-none absolute top-1/2 right-[-20%] -translate-y-1/2 text-teal opacity-15"
      ...
      <div className="relative mx-auto max-w-[var(--max-width-site)]">
        <AnimateIn>
          <h2 className="max-w-4xl font-display text-[clamp(2.5rem,5vw,5rem)] leading-[1.05] text-donker">
            Tap mee met de{" "}
            <span className="italic text-teal/80">klank</span> van het moment
          </h2>
        </AnimateIn>
        <AnimateIn delay={0.2}>
          <p className="mt-8 max-w-lg font-body text-base leading-relaxed text-donker/70 md:text-lg">
