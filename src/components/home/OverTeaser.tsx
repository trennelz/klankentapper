    ...
    <section className="px-6 py-24 md:px-10 md:py-40">
      <div className="mx-auto grid max-w-[var(--max-width-site)] gap-12 md:grid-cols-12 md:gap-8">
        ...
        <div className="flex flex-col justify-center md:col-span-6 md:col-start-7">
          ...
          <AnimateIn delay={0.2}>
            <p className="mt-6 max-w-prose font-body text-base leading-relaxed text-ink/70 md:text-lg">
            ...
            <p className="mt-4 max-w-prose font-body text-base leading-relaxed text-ink/70 md:text-lg">
          ...
          <AnimateIn delay={0.3}>
            <Link
              href="/over"
              className="mt-8 inline-block border border-ink px-7 py-3.5 font-body text-sm uppercase tracking-[0.08em] text-ink no-underline transition-colors duration-200 hover:bg-ink hover:text-wit"
            >
